miniaturix 1.2 based on TinyIB and MalaIB (которая была удалена маламутухом из-за тупости).
=================
...
Недостатки
--------------
-Нет капчи, что спамеры могут заспамить или завайпать вашу миниатюрную парашу<br />
